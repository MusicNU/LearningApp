    ...
    return (
        <>
            <ThemeProvider theme={theme}>
                <TextBox name={headingText} width='50%' left='25%' fontSize='50px' marginTop='50px' elevation='0'></TextBox>
                <TextBox name={bodyText} width='30%' left='35%' fontSize='20px' elevation='0'></TextBox>
